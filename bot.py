...
print("=== ФИНАЛЬНЫЙ ТЕСТОВЫЙ РАДАР ЗАПУЩЕН В ГЕРМАНИИ ===")
print(f"Тестовый депозит: {START_DEPOSIT} USDT | Сложный процент: АКТИВЕН | Загрузка маржи: {MARGIN_USAGE_PCT*100}% на {TEST_POOL_LIMIT} слотов")
